...
//------------------------------------------------------------------------------
	...
	public void testMultiComparator() {
		...
		verses.add(new Verse(new Reference(Book.Genesis, 1, 10)));
		verses.add(new Verse(new Reference(Book.Genesis, 1, 9)));
		verses.add(new Verse(new Reference(Book.Genesis, 1, 8)));
		verses.add(new Verse(new Reference(Book.Genesis, 1, 7)));
		verses.add(new Verse(new Reference(Book.Genesis, 1, 6)));
		verses.add(new Verse(new Reference(Book.Genesis, 1, 5)));
		verses.add(new Verse(new Reference(Book.Genesis, 1, 4)));
		verses.add(new Verse(new Reference(Book.Genesis, 1, 3)));
		verses.add(new Verse(new Reference(Book.Genesis, 1, 2)));
		verses.add(new Verse(new Reference(Book.Genesis, 1, 1)));
